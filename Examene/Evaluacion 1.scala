...
def breakingRecords (Num:List[Int]) : Unit =
{
    ...
    //Ciclo for de compracion para vereificar si rompio el records de temporada o no
    for (i <- Num)
    {
        if (i<Minimo)
        {
...
var Scores = List(10,5,20,20,4, 5, 2, 25, 1)
var Scores2 = List(3,4,21,36,10,28,35,5,24,42)

//Imprimir los valores de las temporas
